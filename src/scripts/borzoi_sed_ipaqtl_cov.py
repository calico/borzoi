...
def main():
    ...
    apa_df = (
        apa_df.query("site_type == '3\\' most exon' or site_type == 'Intron'")
        .copy()
    ...
    print(
        "n intron sites = " + str(len(apa_df.query("site_type == 'Intron'"))),
        flush=True,
    )
    print(
        "n utr3 sites   = " + str(len(apa_df.query("site_type == '3\\' most exon'"))),
        flush=True,
    )
